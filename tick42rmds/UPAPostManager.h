...
public:
	...
	RsslUInt32 AddPost(UPABridgePoster_ptr_t poster, PublisherPostMessageReply * reply);
...
private:
	...
	public:
		UPAPostRecord(RsslUInt32 postId, UPABridgePoster_ptr_t poster, PublisherPostMessageReply * reply)
