...
void RMDSNIPublisher::LoginResponse(UPALogin::RsslLoginResponseInfo * pResponseInfo, bool loginSucceeded, const char* extraInfo )
{
...
void RMDSNIPublisher::ConnectionNotification( bool connected, const char* extraInfo )
{
