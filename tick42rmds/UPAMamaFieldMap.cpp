...
typedef unordered_map<from_to_key, UpaAsMamaFieldType, ihash> SpecialConversionMap_t;
...
UpaMamaFieldMapHandler_t::DictionaryMap_ptr_t UpaMamaFieldMapHandler_t::CombineDictionaries()
{
	...
	for(UpaMamaFieldsMap_t::const_iterator cit = map_.cbegin(); cit != map_.cend(); ++cit)
	{
