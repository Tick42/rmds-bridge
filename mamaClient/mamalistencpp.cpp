...
void MamaListen::subscribeToSymbol (const char* symbol)
{
    ...
    sub->create (mTransportsVec[nextTport++],
...
void MamaListen::shutdownListener ()
{
    ...
    if ((mDictTransport !=  NULL)  && (mDictTransport  != mTransportsVec[0]))                 
    {
        delete mDictTransport;
        mDictTransport = NULL;
    }
    
    if ( mTransportsVec[0] != NULL)
    {
        delete  mTransportsVec[0];
         mTransportsVec[0] = NULL;
    }
...
void MamaListen::initializeMama ()
{
    ...
    {
        mDictTransport=mTransportsVec[0];
    }
                             ...
                             MamaMsg&    msg)
{
    ...
    if (mMamaListen->getQuietness() < 2)
    {
        ...
        sprintf (msgBuffer,"%s.%s Type: %s Status %s tid %u \n",
